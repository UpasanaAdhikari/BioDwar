<div class="load_container">
    <div class="flex justify-between">
        <h1>Trainer's info</h1>
        <input type="text" placeholder="Search" id="costumerSearch" onkeyup="trainerSearch()" autocomplete="off">
    </div>
    <table id="table_dataa" class="border-separate border-spacing-2 border border-slate-500">
        <tr>
...
<div class="Containe_t w-full">
    <div class="inner-contain w-fit">
        <div class="">
            <h1 class="text-lg font-bold">Edit Trainer Entry</h1>
        </div>
        <table>
            <tr>
            ...
            <tr>
                <td><button type="submit" id="save" onclick="saveFromEditedInsertTrainerInfo()" class="border w-20 text-white bg-orange-400 hover:bg-orange-500 px-2 py-1 rounded-md mt-5 mb-8 ease-in-out duration-500">Save</button></td>
                <td><button type="submit" id="close" onclick="closebtnofTrainer()" class="border w-20 text-white bg-red-400 hover:bg-orange-500 px-2 py-1 rounded-md mt-5 mb-8 ease-in-out duration-500">Close</button></td>
            </tr>
        </table>
    </div>
</div>
